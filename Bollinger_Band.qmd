...
# Get YTD data
# bnd_data <- tq_get("BND", get = "alphavantage", av_fun = "TIME_SERIES_DAILY", from = as.Date(format(Sys.Date(), "%Y-01-01"))) # |> rename(date = timestamp)
...
```{r}
# Get YTD data
# bndx_data <- tq_get("BNDX", get = "alphavantage", av_fun = "TIME_SERIES_DAILY", from = as.Date(format(Sys.Date(), "%Y-01-01"))) |> rename(date = timestamp)
...
```{r}
# vti_data <- tq_get("VTI", get = "alphavantage", av_fun = "TIME_SERIES_DAILY", from = as.Date(format(Sys.Date(), "%Y-01-01"))) |> rename(date = timestamp)
...
# Get YTD data
# vxus_data <- tq_get("VXUS", get = "alphavantage", av_fun = "TIME_SERIES_DAILY", from = as.Date(format(Sys.Date(), "%Y-01-01"))) |> rename(date = timestamp)
